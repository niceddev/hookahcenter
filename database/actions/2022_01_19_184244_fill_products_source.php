...
class FillProductsSource extends Actionable
{
    ...
    public function up(): void
    {
        DB::table('products')->insert([
            [
                'title' => 'Кальян Alpha Hookah Model Beat',
            ...
            [
                'title' => 'Кальян Alpha Hookah Model S',
            ...
            [
                'title' => 'Кальян Alpha Hookah Model X',
            ...
            [
                'title' => 'Кальян MattPear Simple M',
            ...
            [
                'title' => 'Кальян Mamay Custom Coilovers Micro',
            ...
            [
                'title' => 'Табак для кальяна Adalya (Адалия) 50 грамм',
            ...
            [
                'title' => 'Табак для кальяна Daily Hookah (Дэйли Хука) 250 грамм',
            ...
            [
                'title' => 'Табак для кальяна Black Burn (Блэк Берн) 100 грамм',
            ...
            [
                'title' => 'Табак для кальяна Black Burn (Блэк Берн) 25 грамм',
                'description' => 'В производстве используется только чистый лист сорта Toasted Burley - это определенный бленд крепкого табака, который курится мягче, но при это отлично сохраняет ароматику и крепость. Так же при изготовлении используется кукурузный сироп из Америки, который идеально подходит под табачную основу.',
                'price' => 900,
                'category_id' => 2,
                'created_at' => Carbon::now()->subDays(rand(1,29))
            ...
            [
                'title' => 'Табак для кальяна Dark Side (Дарк Сайд) 100 грамм',
            ...
            [
                'title' => 'Электронная сигарета Plonq 500',
            ...
            [
                'title' => 'Электронная сигарета Elf Bar 800',
            ...
            [
                'title' => 'Колба для кальяна Craft Mini',
                'description' => 'Колба под кальян – необходимый и самый хрупкий структурный элемент. Их изготавливают из стекла, хрусталя, пластика. Вместе с водой служит фильтром для очистки примесей и охлаждает дым.',
                'price' => 5000,
                'category_id' => 4,
                'created_at' => Carbon::now()->subDays(rand(1,29))
            ...
            [
                'title' => 'Колба для кальяна Pizduk',
            ...
            [
                'title' => 'Чаша для кальяна Kong Milk',
            ...
            [
                'title' => 'Чаша для кальяна Kong Space',
                'description' => 'Идеально подходит для жаростойких и крепких табаков, время прогрева: 3-4 минуты. Идеальна в работе с калаудом и обещает долгий процесс курения.',
                'price' => 3800,
                'category_id' => 5,
                'created_at' => Carbon::now()->subDays(rand(1,29))
            ...
            [
                'title' => 'Чаша для кальяна Moon Hookah',
            ...
            [
                'title' => 'Чаша для кальяна ST Classic',
